...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			['Skry',	'milk',		'Made NO funny pr and is LACTOSE BOY',	'https://www.youtube.com/channel/UCB8KzoWDqJJitNvxIBNN6aQ',	 'FFFFFF'],
			['Betopia',	'betopia',		'Is cool person :sunglasses:',	'https://www.youtube.com/channel/UCfjyz9xRhZiRbLMteQloVeg',	 '876F67'],
			[''],
			['Psych Engine Team'],
